...
namespace SCM_System.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> ExportAuditLogs()
        {
            ...
            csv.AppendLine("Timestamp,Action,IpAddress,UserAgent,Reason");

            foreach (var log in logs)
            {
                csv.AppendLine($"{log.Timestamp:yyyy-MM-dd HH:mm:ss},{log.Action},{log.IpAddress},\"{log.UserAgent}\",\"{log.Reason}\"");
            }
